                        ...
                        <div class="border-t border-gray-200 py-6 px-4 sm:px-6">
                            ...
                            modelAttribute="cartItem">
                                ...
                                <sec:authorize access="isAuthenticated()">
                                    ...
                                    <form:button type="submit">Checkout</form:button>
                                    </div>
                                </sec:authorize>
                                <sec:authorize access="!isAuthenticated()">
                                    <div class="mt-6 flex items-center justify-center rounded-md border border-transparent bg-blue-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-blue-700">
                                ...
                                <c:if test="${cart.getTotalPrice() <= 0}">
                                    <div class="mt-6">
                                        <a class="flex items-center justify-center rounded-md border border-transparent bg-blue-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-blue-700">Panier vide</a>
                                    </div>
                                </c:if>
